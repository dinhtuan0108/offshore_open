...
insert  into `oc_currency`(`currency_id`,`title`,`code`,`symbol_left`,`symbol_right`,`decimal_place`,`value`,`status`,`date_modified`) values (1,'Pound Sterling','GBP','£','','2',0.67129999,1,'2013-07-06 19:00:06'),(2,'US Dollar','USD','$','','2',1.00000000,1,'2013-07-07 04:42:35'),(3,'Euro','EUR','','€','2',0.77939999,1,'2013-07-06 19:00:06');
...
insert  into `oc_url_alias`(`url_alias_id`,`query`,`keyword`) values (730,'manufacturer_id=8','apple'),(772,'information_id=4','about_us');
